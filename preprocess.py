...
def preprocess_single_pass(path,outpath,lid_path):
    ...
    if not os.path.exists(path_dict['merged_ply_path']):
        ...
        if metadata['gantry_system_variable_metadata']['scanIsInPositiveDirection'] == "False":
            ...
            merged_down_pcd = merged_down_pcd.translate([22280.82692587-270-343,(float(metadata['gantry_system_variable_metadata']['position x [m]'])-3.798989)/(8.904483-7.964989)*1000,0])
            merged_pcd = merged_pcd.translate([22280.82692587-270,(float(metadata['gantry_system_variable_metadata']['position x [m]'])-3.798989)/(8.904483-7.964989)*1000,0])
            new_east = new_east.translate([22280.82692587-270,(float(metadata['gantry_system_variable_metadata']['position x [m]'])-3.798989)/(8.904483-7.964989)*1000,0])
            new_west = new_west.translate([22280.82692587-270,(float(metadata['gantry_system_variable_metadata']['position x [m]'])-3.798989)/(8.904483-7.964989)*1000,0])
            new_east_down = new_east_down.translate([22280.82692587-270,(float(metadata['gantry_system_variable_metadata']['position x [m]'])-3.798989)/(8.904483-7.964989)*1000,0])
            new_west_down = new_west_down.translate([22280.82692587-270,(float(metadata['gantry_system_variable_metadata']['position x [m]'])-3.798989)/(8.904483-7.964989)*1000,0])
